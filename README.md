...
(NgJaBach) Kindly find the following ipynb file and run it manually. The original ipynb has mismatched drug type, but I've patched that. Also, you should provide a valid API key for OpenAI, with ONE EXTRA newline. If you don't, the code will tell you your API is invalid.
...
(NgJaBach) The above simply mean where your files would be created from the ipynb, no care needed.

(NgJaBach) You thought it was all? Nope, here are the extra ipynb's you have to run in order to proceed to the next step:
